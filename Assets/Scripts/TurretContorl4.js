...
// prefab with a force at the relevant location 
// "TurretProjectileSpawn" which is positioned in the Unity editor.
...
function Shoot(seconds)
{
	...
	var bullet = Instantiate(bulletPrefab, GameObject.Find("TurretProjectileSpawn4").transform.position, 
	Quaternion.identity);
